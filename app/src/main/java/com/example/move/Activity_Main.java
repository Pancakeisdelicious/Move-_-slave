...
public class Activity_Main extends AppCompatActivity implements AutoPermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                map = googleMap;
                if (ActivityCompat.checkSelfPermission(Activity_Main.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(Activity_Main.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void showMyLocationMarker(LatLng curPoint) {
        if (myLocationMarker == null) {
            ...
            myLocationMarker.icon(BitmapDescriptorFactory.fromResource((R.drawable.trophy)));
